 ...
 * Author: bdeliers
 *
 * Created on June 13, 2019, 10:31 AM
 */
...
#pragma config WDTEN = 2        // Watchdog Timer Enable bits WDT comtrolled by SWDEN
...
#define LED_DIR     TRISBbits.TRISB2	// direction of RB2 (OUTP)
#define LED_STATE	LATBbits.LATB2		// state of led (ON/OFF)

__persistent UINT8_T nTours = 0;
